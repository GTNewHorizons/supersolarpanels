...
public class ContainerAdvancedMatter extends ContainerFullInv<TileEntityAdvancedMatter> {
  public ContainerAdvancedMatter(EntityPlayer entityPlayer, TileEntityAdvancedMatter tileEntity1) {
    super(entityPlayer, (TileEntityAdvancedMatter)tileEntity1, 166);
