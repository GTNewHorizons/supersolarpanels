...
public abstract class TileEntitySolarPanelSun extends TileEntityInventory implements IEnergySource, IHasGui, IGuiValueProvider {
	...
	public String getOutput() {
		if (this.active == GenerationState.DAY) {
			return String.format("%s %d %s", Localization.translate("super_solar_panels.gui.generating"), Integer.valueOf(this.dayPower), Localization.translate("ic2.generic.text.EUt"));
		}
