...
public class ItemBotaniaDrill extends ItemDrill {
	...
	protected static final String NAME = "ItemBotaniaDrill";
	...
	public void registerModels(ItemName name) {
		ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("super_solar_panels:" + CaseFormat.LOWER_CAMEL.to(CaseFormat.LOWER_UNDERSCORE, "ItemBotaniaDrill"), null));
	}
	...
	public enum DrillMode {
		NORMAL(TextFormatting.DARK_GREEN, 16, 122),
		BIG_HOLES(TextFormatting.AQUA, 48, 123),
		BIG_HOLES1(TextFormatting.LIGHT_PURPLE, 97, 124);
