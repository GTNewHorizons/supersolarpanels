...
@Mod(modid = Reference.MOD_ID, name = Reference.MOD_NAME, version = Reference.MOD_VERSION, dependencies="required-after:AdvancedSolarPanel; required-after:IC2; before:dreamcraft")
...
public class MainSSP {
	...
	@EventHandler
	   public void PostInit(FMLPostInitializationEvent event) {
		...
		GameRegistry.addRecipe(new ItemStack(BlockSpectralSP, 1), new Object[]{"BBB", "BAB", "BBB", Character.valueOf('A'), new ItemStack(solarsplitter, 1), Character.valueOf('B'), new ItemStack(AdvancedSolarPanel.blockAdvSolarPanel, 1, 3)});
		GameRegistry.addRecipe(new ItemStack(BlockSingularSP, 1), new Object[]{"AAA", "ACA", "AAA", Character.valueOf('A'), new ItemStack(BlockSpectralSP, 1), Character.valueOf('C'), new ItemStack(enderquantumcomponent, 1)});
		GameRegistry.addRecipe(new ItemStack(enderquantumcomponent, 1), new Object[]{"ABA", "BCB", "ABA", Character.valueOf('A'), IC2Items.getItem("iridiumPlate"), Character.valueOf('B'), Items.ender_eye, Character.valueOf('C'), Items.nether_star});
		GameRegistry.addShapelessRecipe(new ItemStack(greencomponent, 1), new Object[]{AdvancedSolarPanel.itemIrradiantGlassPane});
		GameRegistry.addRecipe(new ItemStack(bluecomponent, 1), new Object[]{"AAA", "BBB", "AAA", Character.valueOf('A'), IC2Items.getItem("reinforcedGlass"), Character.valueOf('B'), new ItemStack(Items.dye, 1, 4)});
		GameRegistry.addRecipe(new ItemStack(redcomponent, 1), new Object[]{"AAA", "BBB", "AAA", Character.valueOf('A'), IC2Items.getItem("reinforcedGlass"), Character.valueOf('B'), Items.redstone});
		GameRegistry.addRecipe(new ItemStack(solarsplitter, 1), new Object[]{"ABC", "ABC", "ABC", Character.valueOf('A'), new ItemStack(redcomponent, 1), Character.valueOf('B'), new ItemStack(greencomponent), Character.valueOf('C'), new ItemStack(bluecomponent)});
		GameRegistry.addRecipe(new ItemStack(BlockAdminSP, 1), new Object[]{"AAA", "AAA", "AAA", Character.valueOf('A'), new ItemStack(BlockSingularSP, 1)});
		GameRegistry.addRecipe(new ItemStack(BlockPhotonSP, 1), new Object[]{"AAA", "AAA", "AAA", Character.valueOf('A'), new ItemStack(BlockAdminSP, 1)});
		}
	}
