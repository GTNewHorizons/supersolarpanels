...
public class TileSolarGeneratorEnergy extends TileEntityElectricMachine
	...
	public double maxSunEnergy;
	public int tick = 0;
	public TileSolarGeneratorEnergy() {
		super(0, 11, 1);
		this.progress = 0;
		this.sunenergy = 0D;
		this.maxSunEnergy = 1000D;
	...
	protected void updateEntityServer() {
		...
		return;
		int tick = (int) this.worldObj.provider.getWorldTime();
...
/*	@SideOnly(Side.CLIENT)
	...
	public ContainerBase<? extends TileSolarGeneratorEnergy> getGuiContainer(EntityPlayer entityPlayer) {
		return (ContainerBase<? extends TileSolarGeneratorEnergy>) new ContainerQuantumQuarry(entityPlayer, this);
	}*/
