...
import com.Denfop.container.ContainerAdvancedMatter;
import com.Denfop.gui.GuiAdvancedMatter;

public class TileEntityAdvancedMatter extends TileEntityLiquidTankElectricMachine implements IHasGui, IUpgradableBlock {
  ...
  public TileEntityAdvancedMatter() {
    super(Math.round(833333.3F * ConfigUtil.getFloat(MainConfig.get(), "balance/uuEnergyFactor")), 3, -1, 8);
    this.scrap = 0;
    this.StateIdle = 0;
    this.StateRunning = 1;
  ...
  public ContainerBase<TileEntityAdvancedMatter> getGuiContainer(EntityPlayer entityPlayer) {
    return (ContainerBase<TileEntityAdvancedMatter>)new ContainerAdvancedMatter(entityPlayer, this);
  }
  
  @SideOnly(Side.CLIENT)
  public GuiScreen getGui(EntityPlayer entityPlayer, boolean isAdmin) {
    return (GuiScreen)new GuiAdvancedMatter(new ContainerAdvancedMatter(entityPlayer, this));
  }
