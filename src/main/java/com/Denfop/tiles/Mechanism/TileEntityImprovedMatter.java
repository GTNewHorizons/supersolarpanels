...
import com.Denfop.gui.GuiImprovedMatter;

public class TileEntityImprovedMatter extends TileEntityLiquidTankElectricMachine implements IHasGui, IUpgradableBlock {
  ...
  public TileEntityImprovedMatter() {
    super(Math.round(666666.6F * ConfigUtil.getFloat(MainConfig.get(), "balance/uuEnergyFactor")), 3, -1, 8);
    this.scrap = 0;
    this.StateIdle = 0;
    this.StateRunning = 1;
  ...
  public ContainerBase<TileEntityImprovedMatter> getGuiContainer(EntityPlayer entityPlayer) {
    return (ContainerBase<TileEntityImprovedMatter>)new ContainerImprovedMatter(entityPlayer, this);
  }
  
  @SideOnly(Side.CLIENT)
  public GuiScreen getGui(EntityPlayer entityPlayer, boolean isAdmin) {
    return (GuiScreen)new GuiImprovedMatter(new ContainerImprovedMatter(entityPlayer, this));
  }
