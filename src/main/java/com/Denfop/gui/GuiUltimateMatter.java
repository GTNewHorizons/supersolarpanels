...
import com.Denfop.container.ContainerUltimateMatter;
...
public class GuiUltimateMatter extends GuiIC2 {
  ...
  public GuiUltimateMatter(ContainerUltimateMatter containerUltimateMatter) {
    super((ContainerBase)containerUltimateMatter);
    this.container = containerUltimateMatter;
