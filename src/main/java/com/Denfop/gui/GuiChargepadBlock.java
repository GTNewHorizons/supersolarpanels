...
public class GuiChargepadBlock extends GuiContainer {
  ...
  protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    ...
    int e1 = (int)Math.min(((TileEntityChargepadBlock)this.container.base).energy2, ((TileEntityChargepadBlock)this.container.base).maxStorage2);
    int e = (int)Math.min(((TileEntityChargepadBlock)this.container.base).energy, ((TileEntityChargepadBlock)this.container.base).maxStorage);
    this.fontRendererObj.drawString(" " + e, 76, 55, 4210752);
    this.fontRendererObj.drawString(" " + e1, 124, 55, 4210752);
    String output = StatCollector.translateToLocalFormatted("ic2.EUStorage.gui.info.output", new Object[] { Integer.valueOf(((TileEntityChargepadBlock)this.container.base).output) });
