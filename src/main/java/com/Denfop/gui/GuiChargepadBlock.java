...
public class GuiChargepadBlock extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		int e1 = (int) Math.min(((TileEntityChargepadBlock) this.container.base).energy2,
				((TileEntityChargepadBlock) this.container.base).maxStorage2);
		int e = (int) Math.min(((TileEntityChargepadBlock) this.container.base).energy,
				((TileEntityChargepadBlock) this.container.base).maxStorage);
		this.fontRendererObj.drawString(" " + e, 76, 55, 4210752);
		this.fontRendererObj.drawString(" " + e1, 124, 55, 4210752);
		String output = StatCollector.translateToLocalFormatted("ic2.EUStorage.gui.info.output")+ ModUtils.getString( this.container.base.output);
	...
	public void initGui() {
		super.initGui();
		this.buttonList.add(new GuiButton(0, (this.width - this.xSize) / 2 + 113, (this.height - this.ySize) / 2 + 34,
	...
	private static final ResourceLocation background = new ResourceLocation(Constants.TEXTURES,
			"textures/gui/GUIChargedElectricBlockEuRf.png");
}
