...
public class ResourceHandler {
	...
	private static ResourceLocation particles = new ResourceLocation(
			Constants.TEXTURES + "textures/particle/particles.png");
	...
	public static class DownloadThread extends Thread {
		...
		private static boolean checkExistence(String urlS) {
			try {
				...
				String fileName = url.getFile();
				return Arrays.<String>asList(ResourceHandler.getImagesFolder().list())
	...
	private static void addRSPack(boolean refreash) {
		...
		Field f = ReflectionHelper.findField(Minecraft.class,
				new String[] { "defaultResourcePacks", "field_110449_ao" });
	...
	public static void bindDefaultParticles() {
		if (defaultParticles == null)
			try {
				defaultParticles = (ResourceLocation) ReflectionHelper.getPrivateValue(EffectRenderer.class, null,
