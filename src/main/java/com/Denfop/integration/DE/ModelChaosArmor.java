...
public class ModelChaosArmor extends ModelBiped {
	...
	public ModelChaosArmor(float f, boolean isHelmet, boolean isChestPiece, boolean isLeggings, boolean isdBoots) {
		...
		this.head = new ModelRenderOBJ((ModelBase) this, ResourceHandler.getResource("models/armor/DraconicHelmet.obj"),
				ResourceHandler.getResource("textures/models/armor/DraconicHelmet.png"));
		this.body = new ModelRenderOBJ((ModelBase) this, ResourceHandler.getResource("models/armor/DraconicBody.obj"),
				ResourceHandler.getResource("textures/models/armor/DraconicBody.png"));
		this.rightArm = new ModelRenderOBJ((ModelBase) this,
		...
		this.leftArm = new ModelRenderOBJ((ModelBase) this,
		...
		this.belt = new ModelRenderOBJ((ModelBase) this, ResourceHandler.getResource("models/armor/DraconicBelt.obj"),
				ResourceHandler.getResource("textures/models/armor/DraconicBelt.png"));
		this.rightLeg = new ModelRenderOBJ((ModelBase) this,
		...
		this.leftLeg = new ModelRenderOBJ((ModelBase) this,
		...
		this.rightBoot = new ModelRenderOBJ((ModelBase) this,
		...
		this.leftBoot = new ModelRenderOBJ((ModelBase) this,
