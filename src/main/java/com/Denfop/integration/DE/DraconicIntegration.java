...
public class DraconicIntegration {
	...
	private static ArmorMaterial CHAOS_ARMOR = EnumHelper.addArmorMaterial("CHAOS_ARMOR", -1, new int[] { 5, 10, 8, 6 },
			30);

	public static void init() {
		GameRegistry.registerItem(ChaosEnergyCore = new SSPDEItem().setMaxStackSize(64)
				.setUnlocalizedName("ChaosEnergyCore").setTextureName("supersolarpanel:ChaosEnergyCore"),
				"ChaosEnergyCore");
		...
		GameRegistry.registerItem(chaosingot = new SSPDEItem().setMaxStackSize(64).setUnlocalizedName("chaosingot")
				.setTextureName("supersolarpanel:chaosingot"), "chaosingot");
		if (Config.registerDraconicPanels) {
			GameRegistry.registerBlock(blockDESolarPanel = (Block) new blockDESolarPanel(),
					(Class) ItemDESolarPanel.class, "blockDESolarPanel");
	...
	public static void Recipes() {
		GameRegistry.addRecipe(new ItemStack(ChaosEnergyCore, 1), new Object[] { " B ", "BAB", " B ", 'B',
				new ItemStack(chaosingot, 1), 'A', ModItems.draconicEnergyCore });
		Recipes.compressor.addRecipe(
				(IRecipeInput) new RecipeInputItemStack(new ItemStack(ModItems.chaosFragment, 1, 2), 1),
				(NBTTagCompound) null, new ItemStack[] { new ItemStack(chaosingot, 1) });
		...
		GameRegistry.addRecipe(new ItemStack(ChaosPickaxe, 1),
				new Object[] { " D ", "CAC", " B ", 'B', new ItemStack(ChaosEnergyCore, 1), 'A',
						ModItems.draconicPickaxe, 'D', ModItems.chaoticCore, 'C', chaosingot });
		GameRegistry.addRecipe(new ItemStack(ChaosAxe, 1),
				new Object[] { " D ", "CAC", " B ", 'B', new ItemStack(ChaosEnergyCore, 1), 'A', ModItems.draconicAxe,
		...
		GameRegistry.addRecipe(new ItemStack(ChaosSword, 1),
				new Object[] { " D ", "CAC", " B ", 'B', new ItemStack(ChaosEnergyCore, 1), 'A', ModItems.draconicSword,
						'D', ModItems.chaoticCore, 'C', chaosingot });
		GameRegistry.addRecipe(new ItemStack(ChaosBow, 1),
				new Object[] { " D ", "CAC", " B ", 'B', new ItemStack(ChaosEnergyCore, 1), 'A', ModItems.draconicBow,
						'D', ModItems.chaoticCore, 'C', chaosingot });

		GameRegistry.addRecipe(new ItemStack(ChaosDestructionStaff, 1),
				new Object[] { "CDC", "ACE", "CBC", 'B', new ItemStack(ChaosSword, 1), 'A', ChaosPickaxe, 'D',
	...
	public static void render() {
		MinecraftForgeClient.registerItemRenderer(DraconicIntegration.ChaosBow,
				(IItemRenderer) new RenderBowModel(true));
		MinecraftForgeClient.registerItemRenderer(DraconicIntegration.ChaosSword,
				(IItemRenderer) new RenderTool("models/tools/DraconicSword.obj",
		...
		MinecraftForgeClient.registerItemRenderer(DraconicIntegration.ChaosPickaxe,
				(IItemRenderer) new RenderTool("models/tools/DraconicPickaxe.obj",
		...
		MinecraftForgeClient.registerItemRenderer(DraconicIntegration.ChaosAxe,
				(IItemRenderer) new RenderTool("models/tools/DraconicLumberAxe.obj",
		...
		MinecraftForgeClient.registerItemRenderer(DraconicIntegration.ChaosShovel,
				(IItemRenderer) new RenderTool("models/tools/DraconicShovel.obj",
		...
		MinecraftForgeClient.registerItemRenderer(DraconicIntegration.ChaosDestructionStaff,
				(IItemRenderer) new RenderTool("models/tools/DraconicStaffOfPower.obj",
						"textures/models/tools/DraconicStaffOfPower.png",
						(IRenderTweak) DraconicIntegration.ChaosDestructionStaff));
		MinecraftForgeClient.registerItemRenderer((Item) DraconicIntegration.ChaosHelm,
				(IItemRenderer) new RenderArmor(DraconicIntegration.ChaosHelm));
		MinecraftForgeClient.registerItemRenderer((Item) DraconicIntegration.ChaosChest,
				(IItemRenderer) new RenderArmor(DraconicIntegration.ChaosChest));
		MinecraftForgeClient.registerItemRenderer((Item) DraconicIntegration.ChaosLeggs,
				(IItemRenderer) new RenderArmor(DraconicIntegration.ChaosLeggs));
		MinecraftForgeClient.registerItemRenderer((Item) DraconicIntegration.ChaosBoots,
				(IItemRenderer) new RenderArmor(DraconicIntegration.ChaosBoots));
