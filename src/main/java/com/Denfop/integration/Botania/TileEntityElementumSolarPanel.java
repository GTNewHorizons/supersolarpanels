...
public class TileEntityElementumSolarPanel extends TileEntitySolarPanel {
	public TileEntityElementumSolarPanel() {
		super("blockElementumSolarPanel.name", Config.elementiumtier, 0, Config.elementiumgenday,
				Config.elementiumgennight, Config.elementiumoutput, Config.elementiumstorage);
	}
