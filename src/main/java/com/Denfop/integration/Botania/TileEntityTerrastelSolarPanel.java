...
public class TileEntityTerrastelSolarPanel extends TileEntitySolarPanel {
	public TileEntityTerrastelSolarPanel() {
		super("blockTerrastelSolarPanel.name", Config.terasteeltier, 0, Config.terasteelgenday,
				Config.terasteelgennight, Config.terasteeloutput, Config.terasteelstorage);
	}
