...
public class TileEntityManasteelSolarPanel extends TileEntitySolarPanel {
	public TileEntityManasteelSolarPanel() {
		super("blockManasteelSolarPanel.name", Config.manasteeltier, 0, Config.manasteelgenday,
				Config.manasteelgennight, Config.manasteeloutput, Config.manasteelstorage);
	}
