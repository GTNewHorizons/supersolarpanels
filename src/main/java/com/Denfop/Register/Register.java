...
public class Register {
	public static void register() {
		...
		GameRegistry.registerBlock(
				SSPItem.toriyore = new RadiationBlock().setBlockTextureName("supersolarpanel:toriyore")
						.setHardness(0.6f).setStepSound(Block.soundTypeStone).setBlockName("toriyore"),
				(Class) ItemToriyOre.class, "toriyore");

		GameRegistry.registerItem(SSPItem.magnesium_ingot = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("magnesium_ingot").setTextureName("supersolarpanel:magnesium_ingot"),
				"magnesium_ingot");
		GameRegistry.registerItem(SSPItem.magnesium_plate = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("magnesium_plate").setTextureName("supersolarpanel:magnesium_plate"),
				"magnesium_plate");
		GameRegistry.registerItem(SSPItem.magnesium_nugget = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("magnesium_nugget").setTextureName("supersolarpanel:magnesium_nugget"),
				"magnesium_nugget");
		GameRegistry.registerItem(SSPItem.caravky_ingot = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("caravky").setTextureName("supersolarpanel:caravky"), "caravky");

		GameRegistry
				.registerItem(
						SSPItem.advanced_core = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("advanced_core").setTextureName("supersolarpanel:advanced_core"),
						"advanced_core");
		GameRegistry.registerItem(SSPItem.hybrid_core = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("hybrid_core").setTextureName("supersolarpanel:hybrid_core"), "hybrid_core");
		GameRegistry
				.registerItem(
						SSPItem.ultimate_core = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("ultimate_core").setTextureName("supersolarpanel:ultimate_core"),
						"ultimate_core");
		GameRegistry.registerItem(
				SSPItem.spectralSolarHelmet = new ItemSolarPanelHelmet(ItemArmor.ArmorMaterial.DIAMOND,
						IUCore.proxy.addArmor("spectralSolarHelmet"), 0, 4).setUnlocalizedName("spectralSolarHelmet"),
				"spectral_solar_helmet");
		GameRegistry.registerItem(
				SSPItem.singularSolarHelmet = new ItemSolarPanelHelmet(ItemArmor.ArmorMaterial.DIAMOND,
						IUCore.proxy.addArmor("singularSolarHelmet"), 0, 5).setUnlocalizedName("singularSolarHelmet"),
				"singular_solar_helmet");
		GameRegistry.registerBlock(SSPItem.blockSSPSolarPanel = (Block) new BlockSSPSolarPanel(),
				(Class) ItemSSPSolarPanel.class, "BlockSSPSolarPanel");

		GameRegistry.registerItem(SSPItem.enderquantumcomponent = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("Ender-QuantumComponent").setTextureName("supersolarpanel:enderquantumcomponent"),
				"enderquantumcomponent");

		GameRegistry.registerBlock(SSPItem.blockadmin = (Block) new Adminsolarpanel(),
				(Class) ItemAdminSolarPanel.class, "Aminpanel");
		GameRegistry.registerBlock(SSPItem.machines = (Block) new BlockBaseMachine(), (Class) ItemBaseMachine.class,
				"machines");
		GameRegistry.registerBlock(SSPItem.electricblock = (Block) new BlockElectric(), (Class) ItemElectricBlock.class,
				"electricblock");
		GameRegistry.registerBlock(SSPItem.Chargepadelectricblock = (Block) new BlockChargepad(),
				(Class) ItemBlockChargepad.class, "BlockChargepad");

		GameRegistry.registerItem(SSPItem.singularcore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("singularcore").setTextureName("supersolarpanel:singularcore"), "singularcore");
		GameRegistry.registerItem(SSPItem.spectralcore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("spectralcore").setTextureName("supersolarpanel:spectralcore"), "spectralcore");
		GameRegistry.registerItem(SSPItem.photoniy = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("photoniy").setTextureName("supersolarpanel:photoniy"), "photoniy");
		GameRegistry
				.registerItem(
						SSPItem.photoniy_ingot = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniy_ingot").setTextureName("supersolarpanel:photoniy_ingot"),
						"photoniy_ingot");
		GameRegistry.registerItem(SSPItem.dust = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("dust")
				.setTextureName("supersolarpanel:dust"), "dust");
		//
		GameRegistry.registerItem(SSPItem.spinelcrushedore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("spinelcrushedore").setTextureName("supersolarpanel:spinelcrushedore"),
				"spinelcrushedore");
		GameRegistry.registerItem(
				SSPItem.platiumcrushedore = new SSPItemBase().setMaxStackSize(64)
						.setUnlocalizedName("platiumcrushedore").setTextureName("supersolarpanel:platiumcrushedore"),
				"platiumcrushedore");
		GameRegistry.registerItem(SSPItem.nickelcrushedore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("nickelcrushedore").setTextureName("supersolarpanel:nickelcrushedore"),
				"nickelcrushedore");
		GameRegistry.registerItem(SSPItem.magnesiumcrushedore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("magnesiumcrushedore").setTextureName("supersolarpanel:magnesiumcrushedore"),
				"magnesiumcrushedore");
		GameRegistry.registerItem(
				SSPItem.wolframcrushedore = new SSPItemBase().setMaxStackSize(64)
						.setUnlocalizedName("wolframcrushedore").setTextureName("supersolarpanel:wolframcrushedore"),
				"wolframcrushedore");
		GameRegistry.registerItem(
				SSPItem.iridiumcrushedore = new SSPItemBase().setMaxStackSize(64)
		...
		GameRegistry
				.registerItem(
						SSPItem.iridium_nugget = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("iridium_nugget").setTextureName("supersolarpanel:iridium_nugget"),
						"iridium_nugget");
		GameRegistry
				.registerItem(
						SSPItem.michail_plate = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("michail_plate").setTextureName("supersolarpanel:michail_plate"),
						"michail_plate");
		GameRegistry
				.registerItem(
						SSPItem.mikhail_ingot = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("mikhail_ingot").setTextureName("supersolarpanel:mikhail_ingot"),
						"mikhail_ingot");
		GameRegistry
				.registerItem(
						SSPItem.mikhail_nugget = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("mikhail_nugget").setTextureName("supersolarpanel:mikhail_nugget"),
						"mikhail_nugget");
		GameRegistry
				.registerItem(
						SSPItem.platium_ingot = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("platium_ingot").setTextureName("supersolarpanel:platium_ingot"),
						"platium_ingot");
		GameRegistry
				.registerItem(
						SSPItem.platium_nugget = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("platium_nugget").setTextureName("supersolarpanel:platium_nugget"),
						"platium_nugget");
		GameRegistry
				.registerItem(
						SSPItem.platium_plate = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("platium_plate").setTextureName("supersolarpanel:platium_plate"),
						"platium_plate");
		GameRegistry.registerItem(SSPItem.spinel_ingot = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("spinel_ingot").setTextureName("supersolarpanel:spinel_ingot"), "spinel_ingot");
		GameRegistry
				.registerItem(
						SSPItem.spinel_nugget = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("spinel_nugget").setTextureName("supersolarpanel:spinel_nugget"),
						"spinel_nugget");
		GameRegistry.registerItem(SSPItem.spinel_plate = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("spinel_plate").setTextureName("supersolarpanel:spinel_plate"), "spinel_plate");
		GameRegistry
				.registerItem(
						SSPItem.wolfram_ingot = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("wolfram_ingot").setTextureName("supersolarpanel:wolfram_ingot"),
						"wolfram_ingot");
		GameRegistry
				.registerItem(
						SSPItem.wolfram_nugget = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("wolfram_nugget").setTextureName("supersolarpanel:wolfram_nugget"),
						"wolfram_nugget");
		GameRegistry
				.registerItem(
						SSPItem.chromium_ingot = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("chromium_ingot").setTextureName("supersolarpanel:chromium_ingot"),
						"chromium_ingot");
		GameRegistry.registerItem(SSPItem.chromium_nugget = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("chromium_nugget").setTextureName("supersolarpanel:chromium_nugget"),
				"chromium_nugget");
		GameRegistry
				.registerItem(
						SSPItem.chromium_plate = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("chromium_plate").setTextureName("supersolarpanel:chromium_plate"),
						"chromium_plate");

		GameRegistry.registerBlock(
				SSPItem.iridiumore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:iridiumore")
						.setStepSound(Block.soundTypeStone).setBlockName("iridiumore"),
				ItemBlockOre.class, "iridiumore");
		GameRegistry.registerBlock(
				SSPItem.endiridium_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endiridium_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endiridium_stone"), "endiridium_stone");
		GameRegistry.registerBlock(
				SSPItem.netheriridiumrack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:netheriridiumrack")
						.setStepSound(Block.soundTypeStone).setBlockName("netheriridiumrack"), "netheriridiumrack");
		GameRegistry.registerBlock(
				SSPItem.endplatium_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endplatium_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endplatium_stone"), "endplatium_stone");
		GameRegistry.registerBlock(
				SSPItem.netherplatiumrack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:netherplatiumrack")
						.setStepSound(Block.soundTypeStone).setBlockName("netherplatiumrack"), "netherplatiumrack");
		GameRegistry.registerBlock(
				SSPItem.endchromium_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endchromium_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endchromium_stone"), "endchromium_stone");
		GameRegistry.registerBlock(
				SSPItem.netherchromiumrack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:netherchromiumrack")
						.setStepSound(Block.soundTypeStone).setBlockName("netherchromiumrack"), "netherchromiumrack");
		GameRegistry.registerBlock(
				SSPItem.endwolfram_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endwolfram_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endwolfram_stone"), "endwolfram_stone");
		GameRegistry.registerBlock(
				SSPItem.netherwolfram_rack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:netherwolfram_rack")
						.setStepSound(Block.soundTypeStone).setBlockName("netherwolfram_rack"), "netherwolfram_rack");
		GameRegistry.registerBlock(
				SSPItem.endmagnesium_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endmagnesium_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endmagnesium_stone"), "endmagnesium_stone");
		GameRegistry.registerBlock(
				SSPItem.nethermagnesiumrack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:nethermagnesiumrack")
						.setStepSound(Block.soundTypeStone).setBlockName("nethermagnesiumrack"), "nethermagnesiumrack");
		GameRegistry.registerBlock(
				SSPItem.endspinel_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endspinel_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endspinel_stone"), "endspinel_stone");
		GameRegistry.registerBlock(
				SSPItem.netherspinelrack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:netherspinelrack")
						.setStepSound(Block.soundTypeStone).setBlockName("netherspinelrack"), "netherspinelrack");
		GameRegistry.registerBlock(
				SSPItem.endmikhail_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endmikhail_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endmikhail_stone"), "endmikhail_stone");
		GameRegistry.registerBlock(
				SSPItem.nethermikhailrack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:nethermikhailrack")
						.setStepSound(Block.soundTypeStone).setBlockName("nethermikhailrack"), "nethermikhailrack");
		GameRegistry.registerBlock(
				SSPItem.wolframore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:wolframore")
						.setStepSound(Block.soundTypeStone).setBlockName("wolframore"),
				ItemBlockOre.class, "wolframore");
		GameRegistry.registerBlock(
				SSPItem.chromiumore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:chromiumore")
						.setStepSound(Block.soundTypeStone).setBlockName("chromiumore"),
				ItemBlockOre.class, "chromiumore");
		GameRegistry.registerBlock(
				SSPItem.platiumore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:platiumore")
						.setStepSound(Block.soundTypeStone).setBlockName("platiumore"),
				ItemBlockOre.class, "platiumore");
		GameRegistry.registerBlock(
				SSPItem.magnesiumore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:magnesiumore")
						.setStepSound(Block.soundTypeStone).setBlockName("magnesiumore"),
				ItemBlockOre.class, "magnesiumore");

		GameRegistry.registerBlock(
				SSPItem.mikhail_ore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:mikhail_ore")
						.setStepSound(Block.soundTypeStone).setBlockName("mikhail_ore"),
				ItemBlockOre.class, "mikhail_ore");
		GameRegistry
				.registerBlock(
						SSPItem.spinelore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:spinelore")
								.setStepSound(Block.soundTypeStone).setBlockName("spinelore"),
						ItemBlockOre.class, "spinelore");

		GameRegistry.registerBlock(
				SSPItem.endgold_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endgold_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endgold_stone"),
				"endgold_stone");
		//
		GameRegistry.registerBlock(
				SSPItem.magnetitore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:magnetitore")
						.setStepSound(Block.soundTypeStone).setBlockName("magnetitore"),
				ItemBlockOre.class, "magnetitore");
		GameRegistry
				.registerBlock(
						SSPItem.nicelore = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:nicelore")
		...
		GameRegistry.registerBlock(
				SSPItem.endiron_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endiron_stone")
		...
		GameRegistry
				.registerBlock(
						SSPItem.netheremeraldrack = new BlockSSPEmerald(Material.rock)
		...
		GameRegistry
				.registerBlock(
						SSPItem.nethercopperrack = new BlockOre(Material.rock)
								.setBlockTextureName("supersolarpanel:nethercopperrack")
								.setStepSound(Block.soundTypeStone).setBlockName("nethercopperrack"),
						"nethercopperrack");

		GameRegistry.registerBlock(
				SSPItem.enduran_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:enduran_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("enduran_stone"),
				"enduran_stone");

		GameRegistry
				.registerBlock(
						SSPItem.enddiamond_stone = new BlockSSPDiamond(Material.rock)
		...
		GameRegistry.registerBlock(
				SSPItem.endtin_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endtin_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endtin_stone"),
				"endtin_stone");

		GameRegistry
				.registerBlock(
						SSPItem.netherdiamondrack = new BlockSSPDiamond(Material.rock)
		...
		GameRegistry.registerBlock(
				SSPItem.nethertinrack = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:nethertinrack")
		...
		GameRegistry.registerBlock(
				SSPItem.endlead_stone = new BlockOre(Material.rock).setBlockTextureName("supersolarpanel:endlead_stone")
						.setStepSound(Block.soundTypeStone).setBlockName("endlead_stone"),
				"endlead_stone");
		GameRegistry
				.registerBlock(
						SSPItem.endredstone_stone = new BlockSSPRedstone(Material.rock)
		...
		GameRegistry
				.registerBlock(
						SSPItem.netherredstonerack = new BlockSSPRedstone(Material.rock)
								.setBlockTextureName("supersolarpanel:netherredstonerack")
								.setStepSound(Block.soundTypeStone).setBlockName("netherredstonerack"),
						"netherredstonerack");
		GameRegistry
				.registerBlock(
						SSPItem.endemerald_stone = new BlockSSPEmerald(Material.rock)
		...
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems2 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems2").setTextureName("supersolarpanel:QuantumItems2"),
						"QuantumItems2");
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems3 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems3").setTextureName("supersolarpanel:QuantumItems3"),
						"QuantumItems3");
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems4 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems4").setTextureName("supersolarpanel:QuantumItems4"),
						"QuantumItems4");
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems5 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems5").setTextureName("supersolarpanel:QuantumItems5"),
						"QuantumItems5");
		GameRegistry.registerItem(SSPItem.nanoBox = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("nanobox")
				.setTextureName("supersolarpanel:nanobox"), "nanobox");
		GameRegistry.registerItem(SSPItem.photoniccore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("photoniccore").setTextureName("supersolarpanel:photoniccore"), "photoniccore");
		GameRegistry.registerItem(SSPItem.admincore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("admincore").setTextureName("supersolarpanel:admincore"), "admincore");
		GameRegistry
				.registerItem(
						SSPItem.wolfram_plate = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("wolfram_plate").setTextureName("supersolarpanel:wolfram_plate"),
						"wolfram_plate");
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems6 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems6").setTextureName("supersolarpanel:QuantumItems6"),
						"QuantumItems6");
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems7 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems7").setTextureName("supersolarpanel:QuantumItems7"),
						"QuantumItems7");
		GameRegistry.registerItem(SSPItem.neutronium = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("neutronium").setTextureName("supersolarpanel:neutronium"), "neutronium");
		GameRegistry.registerItem(SSPItem.neutroniumingot = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("neutroniumingot").setTextureName("supersolarpanel:neutroniumingot"),
				"neutroniumingot");
		GameRegistry
				.registerItem(
						SSPItem.neutroniumcore = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("neutroniumcore").setTextureName("supersolarpanel:neutroniumcore"),
						"neutroniumcore");
		GameRegistry.registerBlock(SSPItem.blocksintezator = (Block) new Sintezator(), (Class) ItemSintezator.class,
				"BlockSintezator");

		GameRegistry.registerItem(
				SSPItem.advancedSolarHelmet = new ItemSolarPanelHelmet(ItemArmor.ArmorMaterial.DIAMOND,
						IUCore.proxy.addArmor("advancedSolarHelmet"), 0, 1).setUnlocalizedName("advancedSolarHelmet"),
				"advanced_solar_helmet");
		GameRegistry.registerItem(
				SSPItem.hybridSolarHelmet = new ItemSolarPanelHelmet(ItemArmor.ArmorMaterial.DIAMOND,
						IUCore.proxy.addArmor("hybridSolarHelmet"), 0, 2).setUnlocalizedName("hybridSolarHelmet"),
				"hybrid_solar_helmet");
		GameRegistry.registerItem(
				SSPItem.ultimateSolarHelmet = new ItemSolarPanelHelmet(ItemArmor.ArmorMaterial.DIAMOND,
		...
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems8 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems8").setTextureName("supersolarpanel:QuantumItems8"),
						"QuantumItems8");
		GameRegistry
				.registerItem(
						SSPItem.QuantumItems9 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("QuantumItems9").setTextureName("supersolarpanel:QuantumItems9"),
						"QuantumItems9");
		GameRegistry.registerItem(SSPItem.coal_chunk1 = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("coal_chunk").setTextureName("supersolarpanel:coal_chunk"), "coal_chunk");
		GameRegistry
				.registerItem(
						SSPItem.compresscarbon = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("compresscarbon").setTextureName("supersolarpanel:compresscarbon"),
						"compresscarbon");
		GameRegistry.registerItem(SSPItem.compresscarbonultra = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("compresscarbonultra").setTextureName("supersolarpanel:compresscarbonultra"),
				"compresscarbonultra");
		GameRegistry.registerItem(SSPItem.protoncore = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("protoncore").setTextureName("supersolarpanel:protoncore"), "protoncore");
		GameRegistry.registerItem(SSPItem.nightlinse = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("nightlinse").setTextureName("supersolarpanel:nightlinse"), "nightlinse");
		GameRegistry.registerItem(SSPItem.sunlinse = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("sunlinse").setTextureName("supersolarpanel:sunlinse"), "sunlinse");
		GameRegistry.registerItem(SSPItem.rainlinse = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("rainlinse").setTextureName("supersolarpanel:rainlinse"), "rainlinse");
		GameRegistry.registerItem(SSPItem.aerlinse = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("aerlinse").setTextureName("supersolarpanel:aerlinse"), "aerlinse");
		GameRegistry.registerItem(SSPItem.earthlinse = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("earthlinse").setTextureName("supersolarpanel:earthlinse"), "earthlinse");
		GameRegistry.registerItem(SSPItem.netherlinse = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("netherlinse").setTextureName("supersolarpanel:netherlinse"), "netherlinse");
		GameRegistry.registerItem(SSPItem.endlinse = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("endlinse").setTextureName("supersolarpanel:endlinse"), "endlinse");
		// TODO
		GameRegistry.registerItem(SSPItem.nanopickaxe = new EnergyPickaxe(Item.ToolMaterial.EMERALD, "nanopickaxe", 1,
				1, 1000, 1000000, 2, 20, 15, 400, 1600).setUnlocalizedName("nanopickaxe"), "nanopickaxe");
		GameRegistry.registerItem(SSPItem.nanoshovel = new EnergyShovel(Item.ToolMaterial.EMERALD, "nanoshovel", 1, 1,
				1000, 1000000, 2, 20, 10, 400, 1600).setUnlocalizedName("nanoshovel"), "nanoshovel");
		GameRegistry.registerItem(SSPItem.nanoaxe = new EnergyAxe(Item.ToolMaterial.EMERALD, "nanoaxe", 1, 1, 1000,
				1000000, 2, 20, 15, 400, 1600).setUnlocalizedName("nanoaxe"), "nanoaxe");
		GameRegistry
				.registerItem(
						SSPItem.quantumpickaxe = new EnergyPickaxe(Item.ToolMaterial.EMERALD, "quantumpickaxe", 3, 2,
								2500, 10000000, 3, 25, 20, 400, 1600).setUnlocalizedName("quantumpickaxe"),
						"quantumpickaxe");
		GameRegistry.registerItem(SSPItem.quantumshovel = new EnergyShovel(Item.ToolMaterial.EMERALD, "quantumshovel",
				3, 2, 2500, 10000000, 3, 25, 10, 400, 1600).setUnlocalizedName("quantumshovel"), "quantumshovel");
		GameRegistry.registerItem(SSPItem.quantumaxe = new EnergyAxe(Item.ToolMaterial.EMERALD, "quantumaxe", 3, 2,
				2500, 10000000, 3, 25, 20, 400, 1600).setUnlocalizedName("quantumaxe"), "quantumaxe");
		GameRegistry
				.registerItem(
						SSPItem.spectralpickaxe = new EnergyPickaxe(Item.ToolMaterial.EMERALD, "spectralpickaxe", 5, 3,
								5000, 50000000, 4, 30, 25, 400, 1600).setUnlocalizedName("spectralpickaxe"),
						"spectralpickaxe");
		GameRegistry
				.registerItem(
						SSPItem.spectralshovel = new EnergyShovel(Item.ToolMaterial.EMERALD, "spectralshovel", 5, 3,
								5000, 50000000, 4, 30, 10, 400, 1600).setUnlocalizedName("spectralshovel"),
						"spectralshovel");
		GameRegistry.registerItem(SSPItem.spectralaxe = new EnergyAxe(Item.ToolMaterial.EMERALD, "spectralaxe", 5, 3,
		...
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass1 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass1").setTextureName("supersolarpanel:photoniyglass1"),
						"photoniyglass1");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass2 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass2").setTextureName("supersolarpanel:photoniyglass2"),
						"photoniyglass2");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass3 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass3").setTextureName("supersolarpanel:photoniyglass3"),
						"photoniyglass3");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass4 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass4").setTextureName("supersolarpanel:photoniyglass4"),
						"photoniyglass4");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass5 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass5").setTextureName("supersolarpanel:photoniyglass5"),
						"photoniyglass5");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass6 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass6").setTextureName("supersolarpanel:photoniyglass6"),
						"photoniyglass6");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass7 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass7").setTextureName("supersolarpanel:photoniyglass7"),
						"photoniyglass7");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass8 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass8").setTextureName("supersolarpanel:photoniyglass8"),
						"photoniyglass8");
		GameRegistry
				.registerItem(
						SSPItem.photoniyglass9 = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("photoniyglass9").setTextureName("supersolarpanel:photoniyglass9"),
						"photoniyglass9");
		GameRegistry.registerItem(SSPItem.photoniyglass10 = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("photoniyglass10").setTextureName("supersolarpanel:photoniyglass10"),
				"photoniyglass10");

		GameRegistry.registerBlock(SSPItem.machines_base = new BlockMoreMachine(), ItemMoreMachine.class,
				"machines_base");
		GameRegistry.registerBlock(SSPItem.machines_base1 = new BlockMoreMachine2(), ItemMoreMachine2.class,
				"machines_base1");
		
		GameRegistry.registerItem(SSPItem.module8, "WirelessModule1");

		GameRegistry.registerItem(SSPItem.ultDDrill, "ultDDrill");
		GameRegistry.registerItem(SSPItem.module1 = new com.Denfop.item.Modules.ModuleGenerationDay()
				.setMaxStackSize(64).setUnlocalizedName("module1").setTextureName("supersolarpanel:module1"),
				"module1");
		GameRegistry.registerItem(SSPItem.module2 = new com.Denfop.item.Modules.ModuleGenerationNight()
				.setMaxStackSize(64).setUnlocalizedName("module2").setTextureName("supersolarpanel:module2"),
				"module2");
		GameRegistry.registerItem(SSPItem.module3 = new com.Denfop.item.Modules.ModuleStorage().setMaxStackSize(64)
				.setUnlocalizedName("module3").setTextureName("supersolarpanel:module3"), "module3");
		GameRegistry.registerItem(SSPItem.module4 = new com.Denfop.item.Modules.ModuleOutput().setMaxStackSize(64)
				.setUnlocalizedName("module4").setTextureName("supersolarpanel:module4"), "module4");
		GameRegistry.registerItem(SSPItem.module5 = new com.Denfop.item.Modules.ModuleType().setMaxStackSize(64)
...
//
		GameRegistry.registerItem(SSPItem.matter = new SolidMatter().setMaxStackSize(64).setUnlocalizedName("matter")
				.setTextureName("supersolarpanel:matter"), "matter");
		//
		GameRegistry.registerItem(
				SSPItem.chromiumcrushedore = new SSPItemBase().setMaxStackSize(64)
						.setUnlocalizedName("chromiumcrushedore").setTextureName("supersolarpanel:chromiumcrushedore"),
				"chromiumcrushedore");
		GameRegistry
				.registerItem(
						SSPItem.electriumdust = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("electriumdust").setTextureName("supersolarpanel:electriumdust"),
						"electriumdust");
		GameRegistry
				.registerItem(
						SSPItem.electriumingot = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("electriumingot").setTextureName("supersolarpanel:electriumingot"),
						"electriumingot");
		GameRegistry
				.registerItem(
						SSPItem.electriumplate = new SSPItemBase().setMaxStackSize(64)
								.setUnlocalizedName("electriumplate").setTextureName("supersolarpanel:electriumplate"),
						"electriumplate");
		GameRegistry.registerItem(SSPItem.blast = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("blast")
				.setTextureName("supersolarpanel:blast"), "blast");
		GameRegistry.registerItem(SSPItem.invardust = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("invardust").setTextureName("supersolarpanel:invardust"), "invardust");
		GameRegistry.registerItem(SSPItem.invaringot = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("invaringot").setTextureName("supersolarpanel:invaringot"), "invaringot");
		GameRegistry.registerItem(SSPItem.invarplate = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("invarplate").setTextureName("supersolarpanel:invarplate"), "invarplate");
		GameRegistry.registerItem(SSPItem.nickel = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("nickel")
				.setTextureName("supersolarpanel:nickel"), "nickel");
		GameRegistry.registerItem(SSPItem.nickelplate = new SSPItemBase().setMaxStackSize(64)
				.setUnlocalizedName("nickelplate").setTextureName("supersolarpanel:nickelplate"), "nickelplate");
		GameRegistry.registerItem(
				SSPItem.michalovcrushedore = new SSPItemBase().setMaxStackSize(64)
