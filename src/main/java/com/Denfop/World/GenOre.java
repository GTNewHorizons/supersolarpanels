...
public class GenOre implements IWorldGenerator {
	...
	private void generateNether(World world, Random random, int x, int y) {
		if (Config.EnableNetherOres) {
			...
			addOreSpawn1(SSPItem.nethergoldrack, world, random, x, y, 16, 16, 3 + random.nextInt(2), 10, 0, 128);
			
			addOreSpawn2(SSPItem.netherchromiumrack, world, random, x, y, 16, 16, 3 + random.nextInt(2), 8, 0, 128);
			addOreSpawn2(SSPItem.netheriridiumrack, world, random, x, y, 16, 16,  3 + random.nextInt(3), 8, 0, 128);
			addOreSpawn2(SSPItem.nethermagnesiumrack, world, random, x, y, 16, 16, 3 + random.nextInt(2), 8, 0, 128);
			addOreSpawn2(SSPItem.nethermikhailrack, world, random, x, y, 16, 16,  3 + random.nextInt(3), 12, 0, 128);
			addOreSpawn2(SSPItem.netherplatiumrack, world, random, x, y, 16, 16, 3 + random.nextInt(2), 10, 0, 128);
			addOreSpawn2(SSPItem.netherwolfram_rack, world, random, x, y, 16, 16, 3 + random.nextInt(2), 14, 0, 128);
			addOreSpawn2(SSPItem.netherspinelrack, world, random, x, y, 16, 16, 3 + random.nextInt(2), 10, 0, 128);
	...
	private void generateEnd(World world, Random random, int x, int y) {
		if (Config.EnableEndOres) {
			...
			addOreSpawn2(SSPItem.endgold_stone, world, random, x, y, 16, 16, 3, 10, 0, 128);
			
			addOreSpawn2(SSPItem.endchromium_stone, world, random, x, y, 16, 16, 3 + random.nextInt(2), 8, 0, 128);
			addOreSpawn2(SSPItem.endiridium_stone, world, random, x, y, 16, 16,  3 + random.nextInt(3), 8, 0, 128);
			addOreSpawn2(SSPItem.endmagnesium_stone, world, random, x, y, 16, 16, 3 + random.nextInt(2), 8, 0, 128);
			addOreSpawn2(SSPItem.endmikhail_stone, world, random, x, y, 16, 16,  3 + random.nextInt(3), 12, 0, 128);
			addOreSpawn2(SSPItem.endplatium_stone, world, random, x, y, 16, 16, 3 + random.nextInt(2), 10, 0, 128);
			addOreSpawn2(SSPItem.endwolfram_stone, world, random, x, y, 16, 16, 3 + random.nextInt(2), 14, 0, 128);
			addOreSpawn2(SSPItem.endspinel_stone, world, random, x, y, 16, 16, 3 + random.nextInt(2), 10, 0, 128);
