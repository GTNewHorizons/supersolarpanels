...
public class BaseModuleOutput  extends Item implements IModulOutput{
	
	private static int percent;
	public BaseModuleOutput(int percent) {
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List info, boolean b) {
		info.add(StatCollector.translateToLocal("ssp.module4") + " " + percent + "% "
