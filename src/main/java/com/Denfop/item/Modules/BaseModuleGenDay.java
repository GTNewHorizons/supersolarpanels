...
public class BaseModuleGenDay extends Item implements IModulGenDay {
	private static int percent;
	public BaseModuleGenDay(int percent) {
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List info, boolean b) {
		info.add(StatCollector.translateToLocal("ssp.module1") + " +" + percent + "% "
