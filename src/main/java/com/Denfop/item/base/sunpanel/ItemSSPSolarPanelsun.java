...
public class ItemSSPSolarPanelsun extends ItemBlock
{
    private List<String> itemNames;
    
    public ItemSSPSolarPanelsun(final Block b) {
        super(b);
        this.setMaxDamage(0);
    ...
    public void addItemsNames() {
        this.itemNames.add("blockSpectralSolarPanel7");
        this.itemNames.add("blockSingularSolarPanel7");
        this.itemNames.add("blockPhotonicSolarPanel7");
        this.itemNames.add("blockAdminSolarPanel7");
        this.itemNames.add("blockNeutronSolarPanel7");
        this.itemNames.add("blockProtonSolarPanel7");
    }
