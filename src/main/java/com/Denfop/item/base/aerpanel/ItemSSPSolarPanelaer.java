...
package com.Denfop.item.base.aerpanel;
...
public class ItemSSPSolarPanelaer extends ItemBlock
{
    private List<String> itemNames;
    
    public ItemSSPSolarPanelaer(final Block b) {
        super(b);
        this.setMaxDamage(0);
    ...
    public void addItemsNames() {
        this.itemNames.add("blockSpectralSolarPanel1");
        this.itemNames.add("blockSingularSolarPanel1");
        this.itemNames.add("blockPhotonicSolarPanel1");
        this.itemNames.add("blockAdminSolarPanel1");
        this.itemNames.add("blockNeutronSolarPanel1");
        this.itemNames.add("blockProtonSolarPanel1");
    }
