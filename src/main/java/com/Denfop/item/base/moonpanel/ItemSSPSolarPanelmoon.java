...
public class ItemSSPSolarPanelmoon extends ItemBlock
{
    private List<String> itemNames;
    
    public ItemSSPSolarPanelmoon(final Block b) {
        super(b);
        this.setMaxDamage(0);
    ...
    public void addItemsNames() {
        this.itemNames.add("blockSpectralSolarPanel5");
        this.itemNames.add("blockSingularSolarPanel5");
        this.itemNames.add("blockPhotonicSolarPanel5");
        this.itemNames.add("blockAdminSolarPanel5");
        this.itemNames.add("blockNeutronSolarPanel5");
        this.itemNames.add("blockProtonSolarPanel5");
    }
