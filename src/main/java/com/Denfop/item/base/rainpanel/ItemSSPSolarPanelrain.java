...
package com.Denfop.item.base.rainpanel;
...
public class ItemSSPSolarPanelrain extends ItemBlock
{
    private List<String> itemNames;
    
    public ItemSSPSolarPanelrain(final Block b) {
        super(b);
        this.setMaxDamage(0);
    ...
    public void addItemsNames() {
        this.itemNames.add("blockSpectralSolarPanel6");
        this.itemNames.add("blockSingularSolarPanel6");
        this.itemNames.add("blockPhotonicSolarPanel6");
        this.itemNames.add("blockAdminSolarPanel6");
        this.itemNames.add("blockNeutronSolarPanel6");
        this.itemNames.add("blockProtonSolarPanel6");
    }
