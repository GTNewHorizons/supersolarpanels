...
package com.Denfop.item.base.earthpanel;
...
public class ItemSSPSolarPanelearth extends ItemBlock
{
    private List<String> itemNames;
    
    public ItemSSPSolarPanelearth(final Block b) {
        super(b);
        this.setMaxDamage(0);
    ...
    public void addItemsNames() {
        this.itemNames.add("blockSpectralSolarPanel2");
        this.itemNames.add("blockSingularSolarPanel2");
        this.itemNames.add("blockPhotonicSolarPanel2");
        this.itemNames.add("blockAdminSolarPanel2");
        this.itemNames.add("blockNeutronSolarPanel2");
        this.itemNames.add("blockProtonSolarPanel2");
    }
