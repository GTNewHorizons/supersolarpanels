		...
		for (Map.Entry<IMicrochipFarbricatorRecipeManager.Input, RecipeOutput> entry : this.recipes.entrySet()) {
			...
			if (recipeInput.matches(container, fill, fill1, fill2, container1)) {
				if (acceptTest || (container != null && container.stackSize >= recipeInput.container.getAmount()
						&& container1 != null && container1.stackSize >= recipeInput.container1.getAmount()
						&& fill != null && fill.stackSize >= recipeInput.fill.getAmount() && fill1 != null
						&& fill1.stackSize >= recipeInput.fill1.getAmount() && fill2 != null
