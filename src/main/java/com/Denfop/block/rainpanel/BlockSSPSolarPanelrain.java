package com.Denfop.block.rainpanel;
...
import com.Denfop.tiles.rainpanel.TileAdminRainPanel;
import com.Denfop.tiles.rainpanel.TileNeutronRainPanel;
import com.Denfop.tiles.rainpanel.TilePhotonicRainPanel;
import com.Denfop.tiles.rainpanel.TileProtonRainPanel;
import com.Denfop.tiles.rainpanel.TileSingularRainPanel;
import com.Denfop.tiles.rainpanel.TileSpectralRainPanel;
...
public class BlockSSPSolarPanelrain extends BlockContainer{
    public boolean qgActive;
    private IIcon[][] iconBuffer;
    
    public BlockSSPSolarPanelrain() {
        super(Material.iron);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:ssp_toprain");
        ...
        this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:ssp_toprain");
        ...
        this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:spsp_toprain");
        ...
        this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:spsp_toprain");
        ...
        this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:admsp_toprain");
        ...
        this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:admsp_toprain");
        ...
        this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:phsp_toprain");
        ...
        this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:phsp_toprain");
        ...
        this.iconBuffer[4][1] = par1IconRegister.registerIcon("supersolarpanel:nsp_toprain");
        ...
        this.iconBuffer[4][7] = par1IconRegister.registerIcon("supersolarpanel:nsp_toprain");
        ...
        this.iconBuffer[5][1] = par1IconRegister.registerIcon("supersolarpanel:psp_toprain");
        ...
        this.iconBuffer[5][7] = par1IconRegister.registerIcon("supersolarpanel:psp_toprain");
    ...
    public TileEntity getBlockEntity(final int i) {
        switch (i) {
            case 0: {
                return new TileSpectralRainPanel();
            }
            case 1: {
                return new TileSingularRainPanel();
            }
            case 2: {
                return new TilePhotonicRainPanel();
            }
            case 3: {
                return new TileAdminRainPanel();
            }
            case 4: {
                return new TileNeutronRainPanel();
            }
            case 5: {
            	 return new TileProtonRainPanel();
            }
