...
import com.Denfop.tiles.rainpanel.TileEntityAdvancedRainPanel;
import com.Denfop.tiles.rainpanel.TileEntityHybridRainPanel;
import com.Denfop.tiles.rainpanel.TileEntityQuantumRainPanel;
import com.Denfop.tiles.rainpanel.TileEntityUltimateRainPanel;
...
public class BlockAdvSolarPanelrain extends BlockContainer {
  public boolean qgActive;
  
  private IIcon[][] iconBuffer;
  
  public BlockAdvSolarPanelrain() {
    super(Material.iron);
    setHardness(3.0F);
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister) {
    ...
    this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:asp_toprain");
    ...
    this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:asp_toprain");
    ...
    this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:hsp_toprain");
    ...
    this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:hsp_toprain");
    ...
    this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:usp_toprain");
    ...
    this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:usp_toprain");
    ...
    this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:qsp_toprain");
    ...
    this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:qsp_toprain");
  ...
  public TileEntity getBlockEntity(int i) {
    switch (i) {
      case 0:
        return (TileEntity)new TileEntityAdvancedRainPanel();
      case 1:
        return (TileEntity)new TileEntityHybridRainPanel();
      case 2:
        return (TileEntity)new TileEntityUltimateRainPanel();
      case 3:
        return (TileEntity)new TileEntityQuantumRainPanel();
