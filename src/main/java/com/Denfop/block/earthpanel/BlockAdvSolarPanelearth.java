...
import com.Denfop.tiles.earthpanel.TileEntityAdvancedEarthPanel;
import com.Denfop.tiles.earthpanel.TileEntityHybridEarthPanel;
import com.Denfop.tiles.earthpanel.TileEntityQuantumEarthPanel;
import com.Denfop.tiles.earthpanel.TileEntityUltimateEarthPanel;
...
public class BlockAdvSolarPanelearth extends BlockContainer {
  public boolean qgActive;
  
  private IIcon[][] iconBuffer;
  
  public BlockAdvSolarPanelearth() {
    super(Material.iron);
    setHardness(3.0F);
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister) {
    ...
    this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:asp_topearth");
    ...
    this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:asp_topearth");
    ...
    this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:hsp_topearth");
    ...
    this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:hsp_topearth");
    ...
    this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:usp_topearth");
    ...
    this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:usp_topearth");
    ...
    this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:qsp_topearth");
    ...
    this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:qsp_topearth");
  ...
  public TileEntity getBlockEntity(int i) {
    switch (i) {
      case 0:
        return (TileEntity)new TileEntityAdvancedEarthPanel();
      case 1:
        return (TileEntity)new TileEntityHybridEarthPanel();
      case 2:
        return (TileEntity)new TileEntityUltimateEarthPanel();
      case 3:
        return (TileEntity)new TileEntityQuantumEarthPanel();
