package com.Denfop.block.earthpanel;
...
import com.Denfop.tiles.earthpanel.TileAdminEarthPanel;
import com.Denfop.tiles.earthpanel.TileNeutronEarthPanel;
import com.Denfop.tiles.earthpanel.TilePhotonicEarthPanel;
import com.Denfop.tiles.earthpanel.TileProtonEarthPanel;
import com.Denfop.tiles.earthpanel.TileSingularEarthPanel;
import com.Denfop.tiles.earthpanel.TileSpectralEarthPanel;
...
public class BlockSSPSolarPanelearth extends BlockContainer{
    public boolean qgActive;
    private IIcon[][] iconBuffer;
    
    public BlockSSPSolarPanelearth() {
        super(Material.iron);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:ssp_topearth");
        ...
        this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:ssp_topearth");
        ...
        this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:spsp_topearth");
        ...
        this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:spsp_topearth");
        ...
        this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:admsp_topearth");
        ...
        this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:admsp_topearth");
        ...
        this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:phsp_topearth");
        ...
        this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:phsp_topearth");
        ...
        this.iconBuffer[4][1] = par1IconRegister.registerIcon("supersolarpanel:nsp_topearth");
        ...
        this.iconBuffer[4][7] = par1IconRegister.registerIcon("supersolarpanel:nsp_topearth");
        ...
        this.iconBuffer[5][1] = par1IconRegister.registerIcon("supersolarpanel:psp_topearth");
        ...
        this.iconBuffer[5][7] = par1IconRegister.registerIcon("supersolarpanel:psp_topearth");
    ...
    public TileEntity getBlockEntity(final int i) {
        switch (i) {
            case 0: {
                return new TileSpectralEarthPanel();
            }
            case 1: {
                return new TileSingularEarthPanel();
            }
            case 2: {
                return new TilePhotonicEarthPanel();
            }
            case 3: {
                return new TileAdminEarthPanel();
            }
            case 4: {
                return new TileNeutronEarthPanel();
            }
            case 5: {
            	 return new TileProtonEarthPanel();
            }
