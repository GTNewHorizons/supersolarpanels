package com.Denfop.block.endpanel;
...
import com.Denfop.tiles.endpanel.TileAdminEndPanel;
import com.Denfop.tiles.endpanel.TileNeutronEndPanel;
import com.Denfop.tiles.endpanel.TilePhotonicEndPanel;
import com.Denfop.tiles.endpanel.TileProtonEndPanel;
import com.Denfop.tiles.endpanel.TileSingularEndPanel;
import com.Denfop.tiles.endpanel.TileSpectralEndPanel;
...
public class BlockSSPSolarPanelend extends BlockContainer{
    public boolean qgActive;
    private IIcon[][] iconBuffer;
    
    public BlockSSPSolarPanelend() {
        super(Material.iron);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:ssp_topend");
        ...
        this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:ssp_topend");
        ...
        this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:spsp_topend");
        ...
        this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:spsp_topend");
        ...
        this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:admsp_topend");
        ...
        this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:admsp_topend");
        ...
        this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:phsp_topend");
        ...
        this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:phsp_topend");
        ...
        this.iconBuffer[4][1] = par1IconRegister.registerIcon("supersolarpanel:nsp_topend");
        ...
        this.iconBuffer[4][7] = par1IconRegister.registerIcon("supersolarpanel:nsp_topend");
        ...
        this.iconBuffer[5][1] = par1IconRegister.registerIcon("supersolarpanel:psp_topend");
        ...
        this.iconBuffer[5][7] = par1IconRegister.registerIcon("supersolarpanel:psp_topend");
    ...
    public TileEntity getBlockEntity(final int i) {
        switch (i) {
            case 0: {
                return new TileSpectralEndPanel();
            }
            case 1: {
                return new TileSingularEndPanel();
            }
            case 2: {
                return new TilePhotonicEndPanel();
            }
            case 3: {
                return new TileAdminEndPanel();
            }
            case 4: {
                return new TileNeutronEndPanel();
            }
            case 5: {
            	 return new TileProtonEndPanel();
            }
