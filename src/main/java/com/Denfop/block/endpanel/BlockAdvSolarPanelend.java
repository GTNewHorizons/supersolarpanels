...
import com.Denfop.tiles.endpanel.TileEntityAdvancedEndPanel;
import com.Denfop.tiles.endpanel.TileEntityHybridEndPanel;
import com.Denfop.tiles.endpanel.TileEntityQuantumEndPanel;
import com.Denfop.tiles.endpanel.TileEntityUltimateEndPanel;
...
public class BlockAdvSolarPanelend extends BlockContainer {
  public boolean qgActive;
  
  private IIcon[][] iconBuffer;
  
  public BlockAdvSolarPanelend() {
    super(Material.iron);
    setHardness(3.0F);
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister) {
    ...
    this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:asp_topend");
    ...
    this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:asp_topend");
    ...
    this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:hsp_topend");
    ...
    this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:hsp_topend");
    ...
    this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:usp_topend");
    ...
    this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:usp_topend");
    ...
    this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:qsp_topend");
    ...
    this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:qsp_topend");
  ...
  public TileEntity getBlockEntity(int i) {
    switch (i) {
      case 0:
        return (TileEntity)new TileEntityAdvancedEndPanel();
      case 1:
        return (TileEntity)new TileEntityHybridEndPanel();
      case 2:
        return (TileEntity)new TileEntityUltimateEndPanel();
      case 3:
        return (TileEntity)new TileEntityQuantumEndPanel();
