...
public class TileEntityTripleCompressor extends TileEntityTripleMachine {
  public TileEntityTripleCompressor() {
    ...
    this.inputSlotC = (InvSlotProcessable)new InvSlotProcessableGeneric(this, "inputC", 0, 1, Recipes.compressor);
  }
  ...
  public GuiScreen getGui(EntityPlayer entityPlayer, boolean isAdmin) {
    return (GuiScreen)new GuiTripleCompressor(new ContainerTripleMachine(entityPlayer, this));
  }
