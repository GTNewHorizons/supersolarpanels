...
public class BlocksItems {
	...
	private static void initItems() {
		SSPItem.photon = new ItemStack((Item) new ItemAdvancedWindRotor("photon", Config.Radius3, Config.durability3,
		...
		SSPItem.neutron = new ItemStack((Item) new ItemAdvancedWindRotor("neutron", Config.Radius4, Config.durability4,
		...
		SSPItem.myphical = new ItemStack((Item) new ItemAdvancedWindRotor("myphical", Config.Radius5,
		...
		SSPItem.adronrotor = new ItemStack((Item) new ItemAdvancedWindRotor("adronrotor", Config.Radius5,
		...
		SSPItem.barionrotor = new ItemStack((Item) new ItemAdvancedWindRotor("barionrotor", Config.Radius5,
		...
		SSPItem.sprengerrotor = new ItemStack((Item) new ItemAdvancedWindRotor("sprengerrotor", Config.Radius5,
		...
		SSPItem.nanoSaber = new ItemSpectralSaber("itemNanoSaber", Config.maxCharge, Config.transferLimit, Config.tier,
				Config.spectralsaberactive, Config.spectralsabernotactive);
		SSPItem.nanoSaber1 = new ItemQuantumSaber("itemNanoSaber1", Config.maxCharge1, Config.transferLimit1,
				Config.tier1, Config.spectralsaberactive1, Config.spectralsabernotactive1);
		SSPItem.quantumHelmet = new ItemArmorImprovemedQuantum("itemArmorQuantumHelmet", 0, Config.armor_maxcharge,
				Config.armor_transferlimit, Config.tier);
		SSPItem.quantumBodyarmor = new ItemArmorImprovemedQuantum("itemArmorQuantumChestplate", 1,
				Config.armor_maxcharge_body, Config.armor_transferlimit, Config.tier);
		SSPItem.quantumLeggings = new ItemArmorImprovemedQuantum("itemArmorQuantumLegs", 2, Config.armor_maxcharge,
				Config.armor_transferlimit, Config.tier);
		SSPItem.quantumBoots = new ItemArmorImprovemedQuantum("itemArmorQuantumBoots", 3, Config.armor_maxcharge,
				Config.armor_transferlimit, Config.tier);

		
		SSPItem.module8 = new ItemWirelessModule();
		//
		SSPItem.iridium = new ItemStack((Item) new ItemAdvancedWindRotor("iridium", Config.Radius, Config.durability,
		...
		SSPItem.compressiridium = new ItemStack((Item) new ItemAdvancedWindRotor("compressiridium", Config.Radius1,
		...
		SSPItem.spectral = new ItemStack((Item) new ItemAdvancedWindRotor("spectral", Config.Radius2,
		...
		SSPItem.reactorDepletedprotonSimple = new ItemStack(
				(Item) new ItemRadioactive("reactorDepletedprotonSimple", 10, 100));
		SSPItem.reactorDepletedprotonDual = new ItemStack(
				(Item) new ItemRadioactive("reactorDepletedprotonDual", 10, 100));
		SSPItem.reactorDepletedprotonQuad = new ItemStack(
				(Item) new ItemRadioactive("reactorDepletedprotonQuad", 10, 100));
		SSPItem.reactorDepletedprotoneit = new ItemStack(
				(Item) new ItemRadioactive("reactorDepletedprotoneit", 10, 100));
		SSPItem.reactorprotonSimple = new ItemStack((Item) new ItemReactorproton("reactorprotonSimple", 1,
				Config.ProtonRodCells, Config.ProtonRodHeat, Config.ProtonPower));
		SSPItem.reactorprotonDual = new ItemStack((Item) new ItemReactorproton("reactorprotonDual", 2,
				Config.ProtonRodCells, Config.ProtonRodHeat, Config.ProtonPower));
		SSPItem.reactorprotonQuad = new ItemStack((Item) new ItemReactorproton("reactorprotonQuad", 4,
				Config.ProtonRodCells, Config.ProtonRodHeat, Config.ProtonPower));
		SSPItem.reactorprotoneit = new ItemStack((Item) new ItemReactorproton("reactorprotoneit", 8,
				Config.ProtonRodCells, Config.ProtonRodHeat, Config.ProtonPower));
		SSPItem.proton = new ItemRadioactive("proton", 150, 100);
		SSPItem.toriy = new ItemRadioactive("toriy", 150, 100);
		//
		SSPItem.reactortoriySimple = new ItemStack((Item) new ItemRadiationToriyRod("reactortoriySimple", 1,
				Config.toriyRodCells, Config.toriyRodHeat, Config.toriyPower));
		SSPItem.reactortoriyDual = new ItemStack((Item) new ItemRadiationToriyRod("reactortoriyDual", 2,
				Config.toriyRodCells, Config.toriyRodHeat, Config.toriyPower));
		SSPItem.reactortoriyQuad = new ItemStack((Item) new ItemRadiationToriyRod("reactortoriyQuad", 4,
				Config.toriyRodCells, Config.toriyRodHeat, Config.toriyPower));
		SSPItem.reactorDepletedtoriySimple = new ItemStack(
				(Item) new ItemRadioactive("reactorDepletedtoriySimple", 10, 100));
		SSPItem.reactorDepletedtoriyDual = new ItemStack(
				(Item) new ItemRadioactive("reactorDepletedtoriyDual", 10, 100));
		SSPItem.reactorDepletedtoriyQuad = new ItemStack(
	...
	public static void registermetadata() {
		...
		SSPItem.itemEnrichedPhotoniyAlloy = new ItemStack(
				SSPItem.itemSSP.setUnlocalizedName("itemEnrichedSunnariumAlloy"), 1, 1);
		SSPItem.itemIrradiantGlassPane = new ItemStack(SSPItem.itemSSP.setUnlocalizedName("itemIrradiantGlassPlane"), 1,
				3);
		SSPItem.itemIridiumIronPlate = new ItemStack(SSPItem.itemSSP.setUnlocalizedName("itemIridiumIronPlate"), 1, 4);
		SSPItem.itemReinforcedIridiumIronPlate = new ItemStack(
				SSPItem.itemSSP.setUnlocalizedName("itemReinforcedIridiumIronPlate"), 1, 5);
		SSPItem.itemIrradiantReinforcedPlate = new ItemStack(
				SSPItem.itemSSP.setUnlocalizedName("itemIrradiantReinforcedPlate"), 1, 6);
