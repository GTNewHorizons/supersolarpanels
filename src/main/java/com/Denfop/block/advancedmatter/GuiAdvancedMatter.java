package com.Denfop.block.advancedmatter;
...
public class GuiAdvancedMatter extends GuiIC2 {
  public ContainerAdvancedMatter container;
  
  public String progressLabel;
  
  public String amplifierLabel;
  
  public GuiAdvancedMatter(ContainerAdvancedMatter container1) {
  ...
  protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    ...
    this.fontRendererObj.drawString(((TileEntityAdvancedMatter)this.container.base).getProgressAsString(), 18, 31, 4210752);
    if (((TileEntityAdvancedMatter)this.container.base).scrap > 0) {
      this.fontRendererObj.drawString(this.amplifierLabel, 8, 46, 4210752);
      this.fontRendererObj.drawString("" + ((TileEntityAdvancedMatter)this.container.base).scrap, 8, 58, 4210752);
    } 
    super.drawGuiContainerForegroundLayer(par1, par2);
    FluidStack fluidstack = ((TileEntityAdvancedMatter)this.container.base).getFluidStackfromTank();
    if (fluidstack != null) {
  ...
  protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
    ...
    if (((TileEntityAdvancedMatter)this.container.base).getTankAmount() > 0) {
      IIcon fluidIcon = ((TileEntityAdvancedMatter)this.container.base).getFluidTank().getFluid().getFluid().getIcon();
      if (fluidIcon != null) {
        drawTexturedModalRect(this.xoffset + 96, this.yoffset + 22, 176, 0, 20, 55);
        this.mc.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
        int liquidHeight = ((TileEntityAdvancedMatter)this.container.base).gaugeLiquidScaled(47);
  ...
  public String getName() {
    return StatCollector.translateToLocal("ssp.blockMatter2");
  }
