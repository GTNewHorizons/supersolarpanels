...
import com.Denfop.tiles.nightpanels.TileEntityAdvancedNightPanel;
import com.Denfop.tiles.nightpanels.TileEntityHybridNightPanel;
import com.Denfop.tiles.nightpanels.TileEntityQuantumNightPanel;
import com.Denfop.tiles.nightpanels.TileEntityUltimateNightPanel;
...
public class BlockAdvSolarPanelmoon extends BlockContainer {
  public boolean qgActive;
  
  private IIcon[][] iconBuffer;
  
  public BlockAdvSolarPanelmoon() {
    super(Material.iron);
    setHardness(3.0F);
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister) {
    ...
    this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:asp_topmoon");
    ...
    this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:asp_topmoon");
    ...
    this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:hsp_topmoon");
    ...
    this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:hsp_topmoon");
    ...
    this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:usp_topmoon");
    ...
    this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:usp_topmoon");
    ...
    this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:qsp_topmoon");
    ...
    this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:qsp_topmoon");
  ...
  public TileEntity getBlockEntity(int i) {
    switch (i) {
      case 0:
        return (TileEntity)new TileEntityAdvancedNightPanel();
      case 1:
        return (TileEntity)new TileEntityHybridNightPanel();
      case 2:
        return (TileEntity)new TileEntityUltimateNightPanel();
      case 3:
        return (TileEntity)new TileEntityQuantumNightPanel();
