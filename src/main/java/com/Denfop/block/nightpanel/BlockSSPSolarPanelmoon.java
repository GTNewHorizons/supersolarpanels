package com.Denfop.block.nightpanel;
...
import com.Denfop.tiles.nightpanels.TileAdminNightPanel;
import com.Denfop.tiles.nightpanels.TileNeutronNightPanel;
import com.Denfop.tiles.nightpanels.TilePhotonicNightPanel;
import com.Denfop.tiles.nightpanels.TileProtonNightPanel;
import com.Denfop.tiles.nightpanels.TileSingularNightPanel;
import com.Denfop.tiles.nightpanels.TileSpectralNightPanel;
...
public class BlockSSPSolarPanelmoon extends BlockContainer{
    public boolean qgActive;
    private IIcon[][] iconBuffer;
    
    public BlockSSPSolarPanelmoon() {
        super(Material.iron);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:ssp_topmoon");
        ...
        this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:ssp_topmoon");
        ...
        this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:spsp_topmoon");
        ...
        this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:spsp_topmoon");
        ...
        this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:admsp_topmoon");
        ...
        this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:admsp_topmoon");
        ...
        this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:phsp_topmoon");
        ...
        this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:phsp_topmoon");
        ...
        this.iconBuffer[4][1] = par1IconRegister.registerIcon("supersolarpanel:nsp_topmoon");
        ...
        this.iconBuffer[4][7] = par1IconRegister.registerIcon("supersolarpanel:nsp_topmoon");
        ...
        this.iconBuffer[5][1] = par1IconRegister.registerIcon("supersolarpanel:psp_topmoon");
        ...
        this.iconBuffer[5][7] = par1IconRegister.registerIcon("supersolarpanel:psp_topmoon");
    ...
    public TileEntity getBlockEntity(final int i) {
        switch (i) {
            case 0: {
                return new TileSpectralNightPanel();
            }
            case 1: {
                return new TileSingularNightPanel();
            }
            case 2: {
                return new TilePhotonicNightPanel();
            }
            case 3: {
                return new TileAdminNightPanel();
            }
            case 4: {
                return new TileNeutronNightPanel();
            }
            case 5: {
            	 return new TileProtonNightPanel();
            }
