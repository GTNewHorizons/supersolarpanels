...
public class GuiTripleMetalFormer extends GuiIC2 {
  public ContainerTripleMetalFormer container;
  
  public GuiTripleMetalFormer(ContainerTripleMetalFormer container1) {
  ...
  protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
    ...
    switch (((TileEntityTripleMetalFormer)this.container.base).getMode()) {
      case 0:
  ...
  public String getName() {
    return StatCollector.translateToLocal("ssp.MetalFormer2");
  }
  
  public ResourceLocation getResourceLocation() {
    return new ResourceLocation(SuperSolarPanels.TEXTURES, "textures/gui/GUItripleMetalFormer.png");
  }
}
