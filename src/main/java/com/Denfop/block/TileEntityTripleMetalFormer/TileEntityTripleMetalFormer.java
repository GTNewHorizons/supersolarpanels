...
public class TileEntityTripleMetalFormer extends TileEntityTripleMachine implements INetworkClientTileEntityEventListener {
  private int mode;
  ...
  public TileEntityTripleMetalFormer() {
    ...
    this.inputSlotC = (InvSlotProcessable)new InvSlotProcessableGeneric(this, "inputC", 0, 1, Recipes.metalformerExtruding);
  }
  ...
  public ContainerBase<TileEntityTripleMetalFormer> getGuiContainer(EntityPlayer entityPlayer) {
    return (ContainerBase<TileEntityTripleMetalFormer>)new ContainerTripleMetalFormer(entityPlayer, this);
  }
  
  @SideOnly(Side.CLIENT)
  public GuiScreen getGui(EntityPlayer entityPlayer, boolean isAdmin) {
    return (GuiScreen)new GuiTripleMetalFormer(new ContainerTripleMetalFormer(entityPlayer, this));
  }
