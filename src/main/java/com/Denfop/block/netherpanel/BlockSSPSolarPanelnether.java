package com.Denfop.block.netherpanel;
...
import com.Denfop.tiles.firepanel.TileNeutronNetherPanel;
import com.Denfop.tiles.firepanel.TilePhotonicNetherPanel;
import com.Denfop.tiles.firepanel.TileProtonNetherPanel;
import com.Denfop.tiles.firepanel.TileSingularNetherPanel;
import com.Denfop.tiles.firepanel.TileSpectralNetherPanel;
...
public class BlockSSPSolarPanelnether extends BlockContainer{
    public boolean qgActive;
    private IIcon[][] iconBuffer;
    
    public BlockSSPSolarPanelnether() {
        super(Material.iron);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:ssp_topnether");
        ...
        this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:ssp_topnether");
        ...
        this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:spsp_topnether");
        ...
        this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:spsp_topnether");
        ...
        this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:admsp_topnether");
        ...
        this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:admsp_topnether");
        ...
        this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:phsp_topnether");
        ...
        this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:phsp_topnether");
        ...
        this.iconBuffer[4][1] = par1IconRegister.registerIcon("supersolarpanel:nsp_topnether");
        ...
        this.iconBuffer[4][7] = par1IconRegister.registerIcon("supersolarpanel:nsp_topnether");
        ...
        this.iconBuffer[5][1] = par1IconRegister.registerIcon("supersolarpanel:psp_topnether");
        ...
        this.iconBuffer[5][7] = par1IconRegister.registerIcon("supersolarpanel:psp_topnether");
    ...
    public TileEntity getBlockEntity(final int i) {
        switch (i) {
            case 0: {
                return new TileSpectralNetherPanel();
            }
            case 1: {
                return new TileSingularNetherPanel();
            }
            case 2: {
                return new TilePhotonicNetherPanel();
            }
            case 3: {
                return new TileAdminNetherPanel();
            }
            case 4: {
                return new TileNeutronNetherPanel();
            }
            case 5: {
            	 return new TileProtonNetherPanel();
            }
