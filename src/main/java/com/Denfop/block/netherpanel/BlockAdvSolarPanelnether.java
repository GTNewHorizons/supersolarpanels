...
import com.Denfop.tiles.firepanel.TileEntityAdvancedNetherPanel;
import com.Denfop.tiles.firepanel.TileEntityHybridNetherPanel;
import com.Denfop.tiles.firepanel.TileEntityQuantumNetherPanel;
import com.Denfop.tiles.firepanel.TileEntityUltimateNetherPanel;
...
public class BlockAdvSolarPanelnether extends BlockContainer {
  public boolean qgActive;
  
  private IIcon[][] iconBuffer;
  
  public BlockAdvSolarPanelnether() {
    super(Material.iron);
    setHardness(3.0F);
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister) {
    ...
    this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:asp_topnether");
    ...
    this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:asp_topnether");
    ...
    this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:hsp_topnether");
    ...
    this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:hsp_topnether");
    ...
    this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:usp_topnether");
    ...
    this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:usp_topnether");
    ...
    this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:qsp_topnether");
    ...
    this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:qsp_topnether");
  ...
  public TileEntity getBlockEntity(int i) {
    switch (i) {
      case 0:
        return (TileEntity)new TileEntityAdvancedNetherPanel();
      case 1:
        return (TileEntity)new TileEntityHybridNetherPanel();
      case 2:
        return (TileEntity)new TileEntityUltimateNetherPanel();
      case 3:
        return (TileEntity)new TileEntityQuantumNetherPanel();
