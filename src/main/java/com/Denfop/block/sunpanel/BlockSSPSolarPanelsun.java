package com.Denfop.block.sunpanel;
...
import com.Denfop.tiles.sunpanels.TileAdminSunPanel;
import com.Denfop.tiles.sunpanels.TileNeutronSunPanel;
import com.Denfop.tiles.sunpanels.TilePhotonicSunPanel;
import com.Denfop.tiles.sunpanels.TileProtonSunPanel;
import com.Denfop.tiles.sunpanels.TileSingularSunPanel;
import com.Denfop.tiles.sunpanels.TileSpectralSunPanel;
...
public class BlockSSPSolarPanelsun extends BlockContainer{
    public boolean qgActive;
    private IIcon[][] iconBuffer;
    
    public BlockSSPSolarPanelsun() {
        super(Material.iron);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:ssp_topsun");
        ...
        this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:ssp_topsun");
        ...
        this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:spsp_topsun");
        ...
        this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:spsp_topsun");
        ...
        this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:admsp_topsun");
        ...
        this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:admsp_topsun");
        ...
        this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:phsp_topsun");
        ...
        this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:phsp_topsun");
        ...
        this.iconBuffer[4][1] = par1IconRegister.registerIcon("supersolarpanel:nsp_topsun");
        ...
        this.iconBuffer[4][7] = par1IconRegister.registerIcon("supersolarpanel:nsp_topsun");
        ...
        this.iconBuffer[5][1] = par1IconRegister.registerIcon("supersolarpanel:psp_topsun");
        ...
        this.iconBuffer[5][7] = par1IconRegister.registerIcon("supersolarpanel:psp_topsun");
    ...
    public TileEntity getBlockEntity(final int i) {
        switch (i) {
            case 0: {
                return new TileSpectralSunPanel();
            }
            case 1: {
                return new TileSingularSunPanel();
            }
            case 2: {
                return new TilePhotonicSunPanel();
            }
            case 3: {
                return new TileAdminSunPanel();
            }
            case 4: {
                return new TileNeutronSunPanel();
            }
            case 5: {
            	 return new TileProtonSunPanel();
            }
