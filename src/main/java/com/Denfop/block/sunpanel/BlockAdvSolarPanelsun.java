...
import com.Denfop.tiles.sunpanels.TileEntityAdvancedSunPanel;
import com.Denfop.tiles.sunpanels.TileEntityHybridSunPanel;
import com.Denfop.tiles.sunpanels.TileEntityQuantumSunPanel;
import com.Denfop.tiles.sunpanels.TileEntityUltimateSunPanel;
...
public class BlockAdvSolarPanelsun extends BlockContainer {
  public boolean qgActive;
  
  private IIcon[][] iconBuffer;
  
  public BlockAdvSolarPanelsun() {
    super(Material.iron);
    setHardness(3.0F);
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister) {
    ...
    this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:asp_topsun");
    ...
    this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:asp_topsun");
    ...
    this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:hsp_topsun");
    ...
    this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:hsp_topsun");
    ...
    this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:usp_topsun");
    ...
    this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:usp_topsun");
    ...
    this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:qsp_topsun");
    ...
    this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:qsp_topsun");
  ...
  public TileEntity getBlockEntity(int i) {
    switch (i) {
      case 0:
        return (TileEntity)new TileEntityAdvancedSunPanel();
      case 1:
        return (TileEntity)new TileEntityHybridSunPanel();
      case 2:
        return (TileEntity)new TileEntityUltimateSunPanel();
      case 3:
        return (TileEntity)new TileEntityQuantumSunPanel();
