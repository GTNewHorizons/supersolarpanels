...
import com.Denfop.tiles.aerpanel.TileAdminAirPanel;
import com.Denfop.tiles.aerpanel.TileNeutronAirPanel;
import com.Denfop.tiles.aerpanel.TilePhotonicAirPanel;
import com.Denfop.tiles.aerpanel.TileProtonAirPanel;
import com.Denfop.tiles.aerpanel.TileSingularAirPanel;
import com.Denfop.tiles.aerpanel.TileSpectralAirPanel;
...
public class BlockSSPSolarPanelaer extends BlockContainer{
    public boolean qgActive;
    private IIcon[][] iconBuffer;
    
    public BlockSSPSolarPanelaer() {
        super(Material.iron);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconBuffer[1][1] = par1IconRegister.registerIcon("supersolarpanel:ssp_topaer");
        ...
        this.iconBuffer[1][7] = par1IconRegister.registerIcon("supersolarpanel:ssp_topaer");
        ...
        this.iconBuffer[0][1] = par1IconRegister.registerIcon("supersolarpanel:spsp_topaer");
        ...
        this.iconBuffer[0][7] = par1IconRegister.registerIcon("supersolarpanel:spsp_topaer");
        ...
        this.iconBuffer[3][1] = par1IconRegister.registerIcon("supersolarpanel:admsp_topaer");
        ...
        this.iconBuffer[3][7] = par1IconRegister.registerIcon("supersolarpanel:admsp_topaer");
        ...
        this.iconBuffer[2][1] = par1IconRegister.registerIcon("supersolarpanel:phsp_topaer");
        ...
        this.iconBuffer[2][7] = par1IconRegister.registerIcon("supersolarpanel:phsp_topaer");
        ...
        this.iconBuffer[4][1] = par1IconRegister.registerIcon("supersolarpanel:nsp_topaer");
        ...
        this.iconBuffer[4][7] = par1IconRegister.registerIcon("supersolarpanel:nsp_topaer");
        ...
        this.iconBuffer[5][1] = par1IconRegister.registerIcon("supersolarpanel:psp_topaer");
        ...
        this.iconBuffer[5][7] = par1IconRegister.registerIcon("supersolarpanel:psp_topaer");
    ...
    public TileEntity getBlockEntity(final int i) {
        switch (i) {
            case 0: {
                return new TileSpectralAirPanel();
            }
            case 1: {
                return new TileSingularAirPanel();
            }
            case 2: {
                return new TilePhotonicAirPanel();
            }
            case 3: {
                return new TileAdminAirPanel();
            }
            case 4: {
                return new TileNeutronAirPanel();
            }
            case 5: {
            	 return new TileProtonAirPanel();
            }
