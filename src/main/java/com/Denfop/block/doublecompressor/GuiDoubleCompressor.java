...
public class GuiDoubleCompressor extends GuiIC2 {
  ...
  public GuiDoubleCompressor(ContainerDoubleMachine container1) {
  ...
  protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
    ...
    int chargeLevel = (int)(14.0F * ((TileEntityElectricMachine) this.container.base).getChargeLevel());
    ...
    if (progress > 0)
      drawTexturedModalRect(this.xoffset + 79, this.yoffset + 34, 176, 14, progress , 16); 
  }
