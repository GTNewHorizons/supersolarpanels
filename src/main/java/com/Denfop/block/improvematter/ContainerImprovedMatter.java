...
public class ContainerImprovedMatter extends ContainerFullInv<TileEntityImprovedMatter> {
  public ContainerImprovedMatter(EntityPlayer entityPlayer, TileEntityImprovedMatter tileEntity1) {
    super(entityPlayer, (TileEntityImprovedMatter)tileEntity1, 166);
