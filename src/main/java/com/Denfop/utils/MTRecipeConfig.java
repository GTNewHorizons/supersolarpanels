...
public class MTRecipeConfig
{
    ...
    public static void populateDefaults() {
        if (!MTRecipeConfig.filled) {
            ...
            MTRecipeConfig.defaultLines.add("minecraft:iron_ingot:1; IC2:itemOreIridium:1; 7500000");
            MTRecipeConfig.defaultLines.add("IC2:itemOreIridium:1; supersolarpanel:photoniy:1; 40000000");
            ...
            MTRecipeConfig.defaultLines.add("minecraft:glowstone_dust:1; supersolarpanel:asp_crafting_items-9:1; 800000");
            MTRecipeConfig.defaultLines.add("minecraft:glowstone:1; supersolarpanel:asp_crafting_items-0:1; 6500000");
            ...
            MTRecipeConfig.defaultLines.add("oredict:ingotSilver:1; oredict:ingotGold:1; 400000");
    ...
    public static void writeGuide(final BufferedWriter bw) {
        try {
            ...
            bw.write("#                        AdvancedSolarPanels Molecular Transformer Recipes                       #" + MTRecipeConfig.NEW_LINE);
            bw.write("##################################################################################################" + MTRecipeConfig.NEW_LINE);
